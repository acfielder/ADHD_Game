...
#func test_init():
#	var first_trial = SequenceTrialInfo.new(0, 5, [1,2,3,4,5])
#	assert_eq(first_trial.get_sequence_type(),0,"should be forward")
...
#	var second_trial = SequenceTrialInfo.new(1,4,[1,2,3,4])
#	assert_eq(second_trial.get_sequence_type(),1,"should be reversed")
#	assert_eq(second_trial.get_length(),4, "should be length 4")
#	assert_eq(second_trial.get_mem_order(), [1,2,3,4], "should be same")
#	assert_eq(second_trial.get_reversed_order(), [4,3,2,1], "should be reversed of mem_order")
...
#	var trial = SequenceTrialInfo.new(0,4,[2,3,5,1])
...
#	
#	var rev_trial = SequenceTrialInfo.new(1,6,[1,2,4,5,2,4])
...
#	var trial = SequenceTrialInfo.new(0,5,[5,4,5,3,2])
#	trial.score = 5
...
#	trial = SequenceTrialInfo.new(0,8,[1,2,3,4,5,4,3,1])
#	trial.score = 8
...
#	var rev_trial = SequenceTrialInfo.new(1,3,[1,3,2])
#	rev_trial.score = 3
...
#	var trial = SequenceTrialInfo.new(0,4,[3,2,4,1])
...
#	var rev_trial = SequenceTrialInfo.new(1,5,[3,3,4,1,2])
...
#	assert_false(rev_trial.check_update_response(3), "should be false, second to last isnt 3")
